...
import ServiceProfile, {
    ServiceProfileData,
} from "./components/service-profile/ServiceProfile";
...
export class Visual implements IVisual {
    ...
    public update(options: VisualUpdateOptions): void {
        ...
        const item = this.parseSelectedService(dataView);

        this.root.render(<ServiceProfile data={item} />);
    }

    private parseSelectedService(dataView: DataView | undefined): ServiceProfileData | null {
