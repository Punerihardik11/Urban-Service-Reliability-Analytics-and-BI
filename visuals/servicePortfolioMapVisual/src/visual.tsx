...
import ServicePortfolioMap, {
    ServicePortfolioPoint,
} from "./components/service-portfolio/ServicePortfolioMap";
...
export class Visual implements IVisual {
    ...
    private parseData(dataView: DataView | undefined): ServicePortfolioPoint[] {
        ...
        const rows: ServicePortfolioPoint[] = [];
        ...
        for (let index = 0; index < rowCount; index++) {
            ...
            const item: ServicePortfolioPoint = {
                ...
                medianBacklogAge: this.getNumberValue(valueColumns.medianBacklogAge, index),
            };
